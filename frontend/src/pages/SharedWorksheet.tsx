    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-10 text-center pb-12">
          <div className="inline-block bg-white rounded-xl border border-stone-200/60 shadow-sm px-8 py-6">
            <p
              className="text-lg font-bold text-stone-800 mb-2"
              style={{ fontFamily: 'Fraunces, Georgia, serif' }}
            >
              Want practice worksheets for your child?
            </p>
            ...
            <a
              href="/"
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-emerald-700 text-white rounded-lg text-sm font-semibold hover:bg-emerald-800 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
              </svg>
