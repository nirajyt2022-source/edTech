  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 pb-24">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          {children.length === 0 ? (
            <EmptyState
              ...
              description="Add your child's details to get practice matched to their grade."
              action={
      ...
      <div className="mt-10 pt-6 border-t border-border/30 md:hidden">
        <button
          onClick={() => signOut()}
          className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-medium text-destructive hover:bg-destructive/5 transition-colors"
        >
