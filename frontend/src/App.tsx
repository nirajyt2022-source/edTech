  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FAFAF9' }}>
      ...
      <a
        ...
        className="fixed bottom-20 md:bottom-6 right-4 z-50 w-12 h-12 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-105 transition-all print:hidden"
