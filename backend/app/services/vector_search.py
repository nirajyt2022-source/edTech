...
Combines pgvector cosine similarity with existing ilike keyword search,
...
class VectorSearchService:
    ...
    async def hybrid_search(
        ...
        """Run semantic + keyword in parallel, fuse with Reciprocal Rank Fusion."""
        try:
            ...
            fused = _reciprocal_rank_fusion(semantic_results, keyword_results, top_k=top_k)
...
def _reciprocal_rank_fusion(
    ...
    """Fuse two ranked lists using RRF with configurable weights."""
