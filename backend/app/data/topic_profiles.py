...
TOPIC_PROFILES: dict[str, dict] = {
    ...
    "Rhymes and Poems (Class 2)": {
        "allowed_skill_tags": [
            "hin_c2_rhymes_identify",
            "hin_c2_rhymes_use",
            "hin_c2_rhymes_complete",
            "hin_c2_rhymes_error",
            "hin_c2_rhymes_thinking",
        ],
        "allowed_slot_types": ["recognition", "application", "representation", "error_detection", "thinking"],
        "disallowed_keywords": [],
        "disallowed_visual_types": [],
        "default_recipe": [
            {"skill_tag": "hin_c2_rhymes_identify", "count": 3},
            {"skill_tag": "hin_c2_rhymes_use", "count": 3},
            {"skill_tag": "hin_c2_rhymes_complete", "count": 2},
            {"skill_tag": "hin_c2_rhymes_error", "count": 1},
            {"skill_tag": "hin_c2_rhymes_thinking", "count": 1},
        ],
    },
    # Hindi — Class 3
