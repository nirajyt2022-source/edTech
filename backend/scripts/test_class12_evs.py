#!/usr/bin/env python3
"""
Deterministic test for Class 1 & 2 EVS topic profiles.

Validates 12 new topics — no LLM or API key needed.

Usage:
  cd backend
  python scripts/test_class12_evs.py
"""
...
# ── The 12 EVS topics (canonical names) ──
CLASS1_EVS_TOPICS = [
    "My Family (Class 1)",
    "My Body (Class 1)",
...
ALL_EVS_TOPICS = CLASS1_EVS_TOPICS + CLASS2_EVS_TOPICS
...
TOPIC_ALIASES = {
    "My Family (Class 1)": [
        "class 1 family evs", "c1 my family",
        "My Family (Class 1)",
    ],
    "My Body (Class 1)": [
        "class 1 body evs", "c1 my body", "my body",
        "My Body (Class 1)",
    ],
    "Plants Around Us (Class 1)": [
        "class 1 plants", "c1 plants",
        "Plants Around Us (Class 1)",
    ],
    "Animals Around Us (Class 1)": [
        "class 1 animals", "c1 animals evs",
        "Animals Around Us (Class 1)",
    ],
    "Food We Eat (Class 1)": [
        "class 1 food", "c1 food",
        "Food We Eat (Class 1)",
    ],
    "Seasons and Weather (Class 1)": [
        "c1 seasons", "c1 weather", "seasons and weather",
        "Seasons and Weather (Class 1)",
    ],
    "Plants (Class 2)": [
        "class 2 plants", "c2 plants evs",
        "Plants (Class 2)",
    ],
    "Animals and Habitats (Class 2)": [
        "class 2 animals", "c2 animals", "animals and habitats",
        "Animals and Habitats (Class 2)",
    ],
    "Food and Nutrition (Class 2)": [
        "class 2 food", "c2 food", "food and nutrition class 2",
        "Food and Nutrition (Class 2)",
    ],
    "Water (Class 2)": [
        "class 2 water", "c2 water",
        "Water (Class 2)",
    ],
    "Shelter (Class 2)": [
        "class 2 shelter", "c2 shelter",
        "Shelter (Class 2)",
    ],
    "Our Senses (Class 2)": [
        "class 2 senses", "c2 senses", "our senses",
        "Our Senses (Class 2)",
    ],
}

# ── Maths keywords that EVS topics must disallow ──
MATHS_KEYWORDS = {"add", "subtract", "multiply", "divide"}


print("=" * 60)
print("=== Class 1 & 2 EVS — Deterministic Checks ===")
print("=" * 60)

for topic in ALL_EVS_TOPICS:
    print(f"\n{topic}:")
...
for topic in ALL_EVS_TOPICS:
    ...
    # All EVS topics must have subject = "Science"
    if profile.get("subject") == "Science":
        ok(f"{topic}: subject='Science'")
    else:
        fail(f"{topic}: subject='{profile.get('subject')}', expected 'Science'")

    # All EVS topics must disallow maths keywords
