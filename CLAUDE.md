...
Each Health profile additionally has: `subject: "Health"`. Health topics use `VALID_FORMATS_SCIENCE` and skip visual hydration (text-only).
...
- **2026-02-18**: Changes in frontend/src/pages
